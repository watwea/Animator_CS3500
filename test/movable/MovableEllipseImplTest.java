...
/**
 * Tests for methods in the {@link MovableEllipseImpl} class.
 */

public class MovableEllipseImplTest {


  private MovableEllipseImpl tester = new MovableEllipseImpl("Tester");
  ...
  private KeyFrame keyFrame08 = new MovableKeyFrameImpl(
          10, -100, -50, 50, 20, 0, 0, 255);
  private KeyFrame keyFrame09 = new MovableKeyFrameImpl(
          9, -100, -50, 50, 20, 0, 0, 255);
  private KeyFrame keyFrame10 = new MovableKeyFrameImpl(
          15, 100, 50, 5, 10, 255, 255, 255);
  ...
  public void testConstructor() {
    ...
    assertEquals(tester.getType(), movableType.ELLIPSE);
  }
  ...
  public void write() {
    ...
    assertEquals(tester.getData(),
            "ELLIPSE - x-cord is: 0.0 y-cord is: 0.0 color is: "
                    + "java.awt.Color[r=0,g=0,b=0] "
                    + "height is: 0.0 width is: 0.0 tick is: 0");
    TICK = 2;
    motion00.move(tester);
    assertEquals(tester.getData(),
            "ELLIPSE - x-cord is: 25.0 y-cord is: 12.5 color is: "
